    ...
    def __init__(self):
      ...
      while True:
        ...
        if msgtype == cfg.MSG_ANGLE_THROTTLE_ROI:
          ...
          reward = Model.rl_fit(trial_roi, reward_roi, trial_angle, trial_throttle, os.path.expanduser(cfg.RL_MODEL_PATH))
          ...
          MsgClnt.sendmsg_weights(weight_cnt, Model.get_weights())
          # Model.clear_session()
